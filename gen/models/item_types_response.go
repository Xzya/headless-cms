...
// ItemTypesResponse item types response
// swagger:model ItemTypesResponse
...
func (m *ItemTypesResponse) validateData(formats strfmt.Registry) error {
