...
func (o *UpdateFieldURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on UpdateFieldURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("ProjectID is required on UpdateFieldURL")
	}
...
func (o *UpdateFieldURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateFieldURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateFieldURL")
	}
