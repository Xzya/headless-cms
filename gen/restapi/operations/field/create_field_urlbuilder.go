...
func (o *CreateFieldURL) Build() (*url.URL, error) {
	...
	var _path = "/projects/{projectId}/item-types/{itemTypeId}/fields"

	itemTypeID := o.ItemTypeID
	if itemTypeID != "" {
		_path = strings.Replace(_path, "{itemTypeId}", itemTypeID, -1)
	} else {
		return nil, errors.New("ItemTypeID is required on CreateFieldURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("ProjectID is required on CreateFieldURL")
	}
...
func (o *CreateFieldURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateFieldURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateFieldURL")
	}
