...
func (o *GetFieldsURL) Build() (*url.URL, error) {
	...
	if itemTypeID != "" {
		...
		return nil, errors.New("ItemTypeID is required on GetFieldsURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("ProjectID is required on GetFieldsURL")
	}
...
func (o *GetFieldsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetFieldsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetFieldsURL")
	}
