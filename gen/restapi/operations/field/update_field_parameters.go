...
// NewUpdateFieldParams creates a new UpdateFieldParams object
...
// UpdateFieldParams contains all the bound params for the update field operation
...
func (o *UpdateFieldParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateFieldParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
