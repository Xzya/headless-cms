...
func (o *GetItemTypesURL) Build() (*url.URL, error) {
	...
	if projectID != "" {
		...
		return nil, errors.New("ProjectID is required on GetItemTypesURL")
	}
...
func (o *GetItemTypesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetItemTypesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetItemTypesURL")
	}
