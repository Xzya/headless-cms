...
// NewGetItemTypeParams creates a new GetItemTypeParams object
// no default values defined in spec.
func NewGetItemTypeParams() GetItemTypeParams {

	return GetItemTypeParams{}
}

// GetItemTypeParams contains all the bound params for the get item type operation
...
func (o *GetItemTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetItemTypeParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
