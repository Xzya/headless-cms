...
func (o *DeleteItemTypeURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on DeleteItemTypeURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("ProjectID is required on DeleteItemTypeURL")
	}
...
func (o *DeleteItemTypeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteItemTypeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteItemTypeURL")
	}
