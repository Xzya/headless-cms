...
func (o *GetItemTypeURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on GetItemTypeURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("ProjectID is required on GetItemTypeURL")
	}
...
func (o *GetItemTypeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetItemTypeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetItemTypeURL")
	}
