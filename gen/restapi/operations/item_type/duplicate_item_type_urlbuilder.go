...
func (o *DuplicateItemTypeURL) Build() (*url.URL, error) {
	...
	var _path = "/projects/{projectId}/item-types/{id}/duplicate"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("ID is required on DuplicateItemTypeURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("ProjectID is required on DuplicateItemTypeURL")
	}
...
func (o *DuplicateItemTypeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DuplicateItemTypeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DuplicateItemTypeURL")
	}
