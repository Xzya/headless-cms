...
// NewCreateItemTypeParams creates a new CreateItemTypeParams object
// no default values defined in spec.
func NewCreateItemTypeParams() CreateItemTypeParams {

	return CreateItemTypeParams{}
}

// CreateItemTypeParams contains all the bound params for the create item type operation
...
func (o *CreateItemTypeParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
