...
// NewUpdateItemTypeParams creates a new UpdateItemTypeParams object
// no default values defined in spec.
func NewUpdateItemTypeParams() UpdateItemTypeParams {

	return UpdateItemTypeParams{}
}

// UpdateItemTypeParams contains all the bound params for the update item type operation
...
func (o *UpdateItemTypeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ItemTypeRequest
...
func (o *UpdateItemTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateItemTypeParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
